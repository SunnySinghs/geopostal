...
JNIEXPORT void JNICALL Java_com_example_geopostal_utils_AddressExpander_setup
...
JNIEXPORT void JNICALL Java_com_example_geopostal_utils_AddressExpander_setupDataDir
...
JNIEXPORT jobjectArray JNICALL Java_com_example_geopostal_utils_AddressExpander_libpostalExpand
...
JNIEXPORT void JNICALL Java_com_example_geopostal_utils_AddressExpander_teardown
  (JNIEnv *env, jclass cls) {
    libpostal_teardown();
