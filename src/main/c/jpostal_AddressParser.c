...
JNIEXPORT void JNICALL Java_com_example_geopostal_utils_AddressParser_setup
...
JNIEXPORT void JNICALL Java_com_example_geopostal_utils_setupDataDir
...
JNIEXPORT jobjectArray JNICALL Java_com_example_geopostal_utils_AddressParser_libpostalParse
  (JNIEnv *env, jobject thisObj, jstring jAddress, jobject jOptions) {
    ...
    jclass parsedComponentClass = (*env)->FindClass(env, "com/example/geopostal/dto/ParsedComponent");
...
JNIEXPORT void JNICALL Java_com_example_geopostal_utils_AddressParser_teardown
  (JNIEnv *env, jclass cls) {
    libpostal_teardown_parser();
}


JNIEXPORT void JNICALL Java_com_example_geopostal_dto_ParserOptions_00024Builder_setDefaultOptions
